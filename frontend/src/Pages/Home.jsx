          ...
          <Row>
            <Col lg="6">
              <div className="hero__content">
                ...
                <p>
                  Traveling enriches your life, broadens perspectives, and
                  creates lasting memories. Explore the world’s wonders, connect
                  with diverse cultures, and cherish every moment of the
                  journey.
                </p>
              </div>
            </Col>
          ...
          <Row>
            <Col lg="6">
              <div className="experience__content">
                ...
                <h2>
                  With our experience <br /> We’re Here to Serve You
                </h2>
                <p>
                  With over a decade of experience, we have successfully crafted
                  <br />
                  countless journeys, ensuring our clients explore the world
                  with
                  <br />
                  confidence and joy.
                  <br />
                  Trust us to make your adventures unforgettable, with every
                  detail
                  <br />
                  taken care of.
                </p>
